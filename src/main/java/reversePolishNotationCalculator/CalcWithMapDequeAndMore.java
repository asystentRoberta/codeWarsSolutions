...
public class CalcWithMapDequeAndMore implements CalcInt {
    ...
    static {
        ...
        operators.put(OPERATOR_MINUS, (subtrahend, minued) -> minued - subtrahend);
    ...
    public double evaluate(final String expr) {
        ...
        for (final String part : parts) {
            ...
            operands.push(operator == null ? Double.parseDouble(part) : operator.applyAsDouble(operands.pop(),
                    operands.pop()));
        }
